...
export default function PartnerForm() {
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-start gap-6 py-12">
        ...
        >
          Thank you for your interest in partnering with Quantum Intel. Your enquiry has been received and will be reviewed by the relevant team. We will be in contact within five business days.
        </p>
        <Link
          href="/"
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-7">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
          <label className={labelClass} style={labelStyle} htmlFor="partnership_type">
            Partnership Type <span style={{ color: "#B8945A" }}>*</span>
          </label>
          <select
            id="partnership_type"
      ...
      <div>
        <label className={labelClass} style={labelStyle} htmlFor="summary">
          Partnership Summary <span style={{ color: "#B8945A" }}>*</span>
        </label>
        <textarea
          id="summary"
          name="summary"
          rows={5}
          required
          placeholder="Describe your background, area of expertise, and how you envision partnering with Quantum Intel."
