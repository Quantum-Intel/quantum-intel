...
export const metadata: Metadata = {
  ...
  description:
    "Capability development for African ministries, agencies, and offices of government across security, intelligence, communications, and emerging technology.",
};

const clientCategories = [
  {
    label: "Federal ministries with security or technology mandates",
  },
  {
    label: "Offices of national security and coordination",
  },
  {
    label: "Public sector communications and information units",
  },
  {
    label: "State-owned strategic enterprises with security exposure",
  },
  {
    label: "Inter-agency bodies and coordination platforms",
  },
  {
    label: "Governance and accountability institutions",
  },
];
...
const howWeEngage = [
  {
    ...
    body: "We conduct a structured assessment of institutional capability gaps, aligned to the ministry or agency mandate, current operating environment, and government priority areas.",
  },
  {
    number: "02",
    title: "Programme Design",
    body: "Programmes are designed specifically for the seniority profile, policy context, and confidentiality requirements of the institution. We do not deliver generic training catalogues.",
  },
  {
    number: "03",
    title: "Confidential Delivery",
    body: "All engagements are delivered under confidentiality arrangements appropriate to the institution's mandate. Programme details, participant identities, and content are protected by default.",
  },
];
        ...
        <div className="relative z-10 flex-1 flex items-center max-w-[1280px] mx-auto px-6 w-full">
          <div className="w-full pt-32 pb-20">
            <div className="pr-0 xl:pr-[38%]">
              ...
              >
                Capability development for government and public sector institutions.
              </h1>
              ...
              >
                Quantum Intel supports ministries, agencies, and offices of government in strengthening institutional capability across security, intelligence, communications, and emerging technology.
              </p>
        ...
        <div className="max-w-[1280px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr] gap-12 lg:gap-24">
            <div className="lg:pt-2">
              ...
              >
                Engagements are designed for the policy, operational, and accountability environment in which African public institutions operate.
              </p>
            ...
            <div>
              ...
              <p
                ...
                style={{ color: "#5A5550" }}
              >
                African governments face a distinct set of capability challenges — a rapidly evolving threat environment, significant technology transitions, and the institutional complexity of operating across multiple security and governance mandates simultaneously. Generic capability development does not address this complexity.
              </p>
              ...
              <p
                ...
                style={{ color: "#5A5550" }}
              >
                Quantum Intel designs and delivers programmes that are grounded in the African public sector operating environment, calibrated to the seniority and mandate of participants, and structured to produce measurable institutional uplift rather than individual certificates.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1280px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr] gap-12 lg:gap-20 mb-12">
            ...
            <div className="flex items-end">
              ...
              >
                Client identities are held in strict confidence. The categories below describe the types of institutions we serve — no client is named without written authorisation.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr] gap-12 lg:gap-20">
            <div>
              <h2
                ...
                style={{ color: "#0A1A2F", fontFamily: "var(--font-display)" }}
              >
                Illustrative programme areas for government clients.
              </h2>
            </div>
            <div>
        ...
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 lg:gap-20 items-end">
            <div>
              ...
              >
                All government enquiries are handled through structured, confidential channels. To initiate an engagement discussion, use the proposal request form.
              </p>
            </div>
